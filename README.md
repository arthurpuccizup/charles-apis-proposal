- See the "PATCH" method bellow the POST workspace, it's a proposal of perhaps allowing create a workspace with all it's properties, but requiring only the name
